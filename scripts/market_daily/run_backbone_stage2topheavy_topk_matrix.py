...
DEFAULT_MODELS = ("PatchTST", "iTransformer", "TimeMixer", "TimesNet", "WPMixer", "Transformer")
...
MODEL_CONFIGS = {
    "PatchTST": {"d_model": 128, "d_ff": 256, "e_layers": 2, "n_heads": 4, "epochs": 20},
    "iTransformer": {"d_model": 128, "d_ff": 256, "e_layers": 2, "n_heads": 4, "epochs": 20},
    "TimeMixer": {"d_model": 128, "d_ff": 256, "e_layers": 2, "n_heads": 4, "epochs": 20},
    "TimesNet": {"d_model": 128, "d_ff": 256, "e_layers": 2, "n_heads": 4, "epochs": 20},
    "WPMixer": {"d_model": 128, "d_ff": 256, "e_layers": 2, "n_heads": 4, "epochs": 20},
    "Transformer": {"d_model": 64, "d_ff": 128, "e_layers": 2, "n_heads": 4, "epochs": 20},
}
...
def build_job_record(year, model, feature_set, seq_len, batch_size, cache_path, learning_rate, des, market_cs_recent_k):
    ...
    distil = "True"
    model_id = f"market_{year}_csattn_transformer_fp32_stage2topheavy_topk_{model}"
    command = [
        sys.executable,
        "run.py",
...
def build_parser():
    parser = argparse.ArgumentParser(description="Run backbone stage2topheavy_topk market matrix")
    subparsers = parser.add_subparsers(dest="cmd", required=True)

    manifest = subparsers.add_parser("manifest")
    manifest.add_argument("--output_dir", default="logs/backbone_stage2topheavy_topk_matrix")
    ...
    manifest.add_argument("--des", default="backbone_stage2topheavy_topk")
    manifest.add_argument("--market_cs_recent_k", type=int, default=5)

    launch = subparsers.add_parser("launch")
    launch.add_argument("--output_dir", default="logs/backbone_stage2topheavy_topk_matrix")
    ...
    launch.add_argument("--des", default="backbone_stage2topheavy_topk")
    ...
    summarize.add_argument("--output_dir", default="logs/backbone_stage2topheavy_topk_matrix")
